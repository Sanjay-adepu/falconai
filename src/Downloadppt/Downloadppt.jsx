...
<div style={{ margin: "1rem 0", backgroundColor: "#f9f9f9", padding: "1rem", borderRadius: "8px", color: "#8d6e63", fontSize: "0.7rem" }}>Note: Save the slides before downloading the PPT.
</div>    
